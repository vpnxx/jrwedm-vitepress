import { nextTick, VNode, CSSProperties, Slot } from 'vue';
export interface Column {
    ...
    sorter?: Function;
    customCell?: (record: Record<string, any>, rowIndex: number, column: Column) => object | undefined;
    [propName: string]: any;
}
export interface Selection {
    ...
    onSelect?: (record: Record<string, any>, selected: boolean, selectedRows: Record<string, any>[], selectedRowKeys: string[]) => void;
    onSelectAll?: (selected: boolean, selectedRows: Record<string, any>[], changeRows: Record<string, any>[], selectedRowKeys: string[], changeRowKeys: string[]) => void;
    getSelectionProps?: (record: Record<string, any>, rowIndex: number) => object;
}
export type ScrollOption = {
    initialScrollPositionOnChange?: boolean;
    ...
    slots: {
        ...
        bodyCell?(_: {
            column: {
                ...
                customCell?: ((record: Record<string, any>, rowIndex: number, column: Column) => object | undefined) | undefined;
            };
            record: Record<string, any>;
            text: any;
            index: number;
