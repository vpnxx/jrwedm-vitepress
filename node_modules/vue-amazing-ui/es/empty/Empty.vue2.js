import { defineComponent as h, computed as n, createElementBlock as t, openBlock as a, normalizeClass as u, createElementVNode as g, createCommentVNode as i, normalizeStyle as d, renderSlot as r, unref as b, createStaticVNode as p, createTextVNode as f, toDisplayString as m } from "vue";
...
const w = ["src"], V = {
  ...
  props: {
    ...
    image: { default: "filled" },
    imageStyle: { default: () => ({}) },
    footer: { default: void 0 }
  },
  setup(c) {
    const s = c, o = z(["default", "description", "footer"]), v = n(() => o.description || s.description), y = n(() => o.footer || s.footer);
    return (e, l) => (a(), t("div", {
      class: u(["empty-wrap", { "empty-image-outlined": e.image === "outlined" }])
    }, [
      g("div", {
        class: "empty-image-wrap",
        style: d(e.imageStyle)
      }, [
        b(o).default ? r(e.$slots, "default", { key: 0 }, void 0, !0) : e.image === "filled" ? (a(), t("svg", {
          key: 1,
          class: "empty-filled",
          style: d(e.imageStyle),
          viewBox: "0 0 184 152",
          ...
          p('<g transform="translate(0 1)" fill="none" fill-rule="evenodd" data-v-830202db><ellipse fill="#f5f5f5" cx="32" cy="33" rx="32" ry="7" data-v-830202db></ellipse><g fill-rule="nonzero" stroke="#d9d9d9" data-v-830202db><path d="M55 12.76L44.854 1.258C44.367.474 43.656 0 42.907 0H21.093c-.749 0-1.46.474-1.947 1.257L9 12.761V22h46v-9.24z" data-v-830202db></path><path d="M41.613 15.931c0-1.605.994-2.93 2.227-2.931H55v18.137C55 33.26 53.68 35 52.05 35h-40.1C10.32 35 9 33.259 9 31.137V13h11.16c1.233 0 2.227 1.323 2.227 2.928v.022c0 1.605 1.005 2.901 2.237 2.901h14.752c1.232 0 2.237-1.308 2.237-2.913v-.007z" fill="#fafafa" data-v-830202db></path></g></g>', 1)
        ])], 4)) : e.image ? (a(), t("img", {
          key: 3,
          class: "empty-image",
          src: e.image,
